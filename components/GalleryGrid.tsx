            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-between bg-gradient-to-br from-surface-elevated to-surface" dir="rtl">
                  ...
                  {/* Close Button */}
                  <motion.button
                    className="mt-8 px-6 py-3 bg-primary hover:bg-primary/90 text-white rounded-lg font-urdu-body text-lg transition-colors duration-200 shadow-lg hover:shadow-xl"
                    onClick={() => setSelectedImage(null)}
